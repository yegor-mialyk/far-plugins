...
const
  ...
  FARMANAGERVERSION_BUILD = 6632;

type
  UUID = TGUID;

const
  CP_UTF16LE = UIntPtr(1200);
  CP_UTF16BE = UIntPtr(1201);
  CP_UNICODE = CP_UTF16LE;
  CP_REVERSEBOM = CP_UTF16BE;
...
const
  ...
  FDLG_STAY_ON_TOP = $0000000000000040;
  FDLG_NONE = 0;
...
const
  ...
  FFFS_MINSIZEINDEX_MASK = $0000000000000007;
  FFFS_NONE = 0;
...
type
  PDetectCodePageInfo = ^DetectCodePageInfo;
  DetectCodePageInfo = record
    StructSize: UIntPtr;
    FileName: PChar;
  end;

type
  FARSTDDETECTCODEPAGE = function (
    Info: PDetectCodePageInfo
  ): UIntPtr; stdcall;
