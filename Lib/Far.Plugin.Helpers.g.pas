...
//     Pascal Preprocessor, version 0.9
//
//     Copyright (C) 1995-2026, Yegor Mialyk. All Rights Reserved.
//
...
{$IFNDEF _FAR_IMPLEMENTATION_}
type
  RegExpStatusHelper = record helper for RegExpStatus
    procedure Init; inline;
  end;
{$ELSE}
procedure RegExpStatusHelper.Init;
begin
  FillChar(Self, SizeOf(RegExpStatus), 0);
  StructSize := SizeOf(RegExpStatus);
end;
{$ENDIF}
...
{$IFNDEF _FAR_IMPLEMENTATION_}
type
  DetectCodePageInfoHelper = record helper for DetectCodePageInfo
    procedure Init; inline;
  end;
{$ELSE}
procedure DetectCodePageInfoHelper.Init;
begin
  FillChar(Self, SizeOf(DetectCodePageInfo), 0);
  StructSize := SizeOf(DetectCodePageInfo);
end;
{$ENDIF}
